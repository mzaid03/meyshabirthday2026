  ...
  return (
    <Screen night>
      ...
      <div className="finalCard">
        ...
        <p>
          And with that... I think Mochi has bothered you enough for one day 😭. Oh and I heard you like shopping at Target so hope you like the other little gift I sent you!!🙂
        </p>
